...
export const api = {
  ...
  startBot: (id: string) => apiFetch(`/bots/${id}/start`, { method: 'POST' }),
  stopBot: (id: string) => apiFetch(`/bots/${id}/stop`, { method: 'POST' }),
  restartBot: (id: string) => apiFetch(`/bots/${id}/restart`, { method: 'POST' }),
  ...
  updateAccount: (data: any) => apiFetch('/auth/update', { method: 'PUT', headers: { 'Content-Type': 'application/json' }, body: JSON.stringify(data) }),
};
